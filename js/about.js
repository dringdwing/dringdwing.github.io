...
function bot_ui_ini() {
    ...
    var sure = function () {
            ...
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "热爱Java，对后端颇感兴趣，了解SSM、SpringBoot等，前端技术以及小程序也比较感兴趣"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                ...
                                botui.message.add({
                                    delay: 1800,
                                    content: "当然闲暇时间喜欢🏀，和小同学打打🎮"
                                }).then(function () {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
                                            text: "博客的域名有什么特殊意义吗？🤔",
                                            value: "why-KoBeBryant"
                                        }]
                                    }).then(function (a) {
                                        thirdpart()
                                    })
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "emmm,力扣刷满500道题，我相信我可以做到！"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
                    content: "与君初相识犹如故人归，祝君更上一层楼"
                })
            })
        }
}
